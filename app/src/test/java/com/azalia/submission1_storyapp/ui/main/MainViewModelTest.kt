...
import com.azalia.submission1_storyapp.DataDummy
import com.azalia.submission1_storyapp.MainDispatcherRule
import com.azalia.submission1_storyapp.data.Repository
import com.azalia.submission1_storyapp.data.local.StoryEntity
import com.azalia.submission1_storyapp.getOrAwaitValue
...
class MainViewModelTest {
    ...
    fun `when Get Story Should Not Null and Return Data`() = runTest {
        ...
        Mockito.`when`(repository.getStory(dummyToken)).thenReturn(expectedStory)

        val mainViewModel = MainViewModel(repository)
        val actualStory: PagingData<StoryEntity> = mainViewModel.getStories(dummyToken).getOrAwaitValue()
